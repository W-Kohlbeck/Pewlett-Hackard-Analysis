...
-- Joining retirement_info and dept_emp tables with only current employees
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
-- Management: A list of managers for each department, including the department number, name, and 
-- the manager's employee number, last name, first name, and the starting and ending employment dates
SELECT  dm.dept_no,
        d.dept_name,
        dm.emp_no,
        ce.last_name,
